...
<%
	...
	'------------------------------------
	*/
	gv_APIUserName	= "preethip001-facilitator_api1.paypal.com";
	gv_APIPassword	= "WUFLF5DUHMCPCF6E";
	gv_APISignature = "AQU0e5vuZCvSg-XJploSa.sGUDlpAiTTgOZlhjiKFcAE89jiCJLogcIh";
