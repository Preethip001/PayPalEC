...
<%
   String Payment_Amount = "200" ;
	...
	sess.setAttribute( "Payment_Amount", Payment_Amount );
%>
<% 
	/*
	'------------------------------------
	...
	*/
	...
	String finalPaymentAmount =  sess.getAttribute("Payment_Amount").toString();
	/*
	'------------------------------------
	...
	*/
	...
	sess.setAttribute("PAYERID", PayerID);
	sess.setAttribute("TOKEN", token);
	HashMap nvp = ConfirmPayment(finalPaymentAmount, sess,request);
	...
	if(strAck !=null && (strAck.equalsIgnoreCase("Success") || strAck.equalsIgnoreCase("SuccessWithWarning")))
	{
		...
		*/
		...
		out.write("<lable>Your order is Confirmed! </lable>");
		out.write("<lable>Please make note of the following details for your reference. </lable>");
		out.write("<table>");
		out.write("<tr><td>Transaction Id</td><td>:</td><td>");
		out.write(transactionId);
		out.write("</td></tr>");
		out.write("<tr><td>Transaction Type</td><td>:</td><td>");
		out.write(transactionType);
		out.write("</td></tr>");
		out.write("<tr><td>Payment Type</td><td>:</td><td>");
		out.write(paymentType);
		out.write("</td></tr>");
		out.write("<tr><td>Time of Order</td><td>:</td><td>");
		out.write(orderTime);
		out.write("</td></tr>");
		out.write("<tr><td>Tax</td><td>:</td><td>");
		out.write(taxAmt);
		out.write("</td></tr>");
		out.write("<tr><td>Final Amount</td><td>:</td><td>");
		out.write(amt);
		out.write("</td></tr>");
		out.write("<tr><td>Currency in</td><td>:</td><td>");
		out.write(currencyCode);
		out.write("</td></tr>");
		out.write("<tr><td>Payment Status</td><td>:</td><td>");
		out.write(paymentStatus);
		out.write("</td></tr>");
		out.write("<tr><td>Reason for pending, if any</td><td>:</td><td>");
		out.write(pendingReason);
		out.write("</td></tr>");
		out.write("</table>");
	}
	else
